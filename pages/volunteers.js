  ...
  return (
    <Layout>
      ...
      <section className="flex flex-auto flex-col items-center justify-end py-14">
        <div className="w-full md:mx-14 lg:w-1/2 lg:pb-8 ">
          <h2 className="text-primary-color">Volunteer Perks</h2>
        </div>
        <div className="mt-16 grid w-full grid-cols-1 justify-center gap-11 sm:grid-cols-2 lg:mt-0  lg:w-1/2 lg:pr-14">
